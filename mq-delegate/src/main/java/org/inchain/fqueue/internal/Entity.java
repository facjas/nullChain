...
import org.inchain.fqueue.exception.FileEOFException;
...
public class Entity {
    ...
    public Entity(String path, int fileNumber, long fileLimitLength, org.inchain.fqueue.internal.Index db)
